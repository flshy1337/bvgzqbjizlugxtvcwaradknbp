...
| KVM-свитч USB (отдельный) | ??к | — |
| KVM-свитч HDMI (мин. 144Hz 2K, отдельный) | ??к | — |

⚠️ CM692 переключает USB и HDMI одновременно одной кнопкой — не устраивает. Нужны два независимых свитча с раздельным переключением USB и HDMI.
...
| Ноги для стола с подъемником | 22к | https://ozon.ru/t/5DtfRLK |
| Кронштейн для 2-х мониторов | 7к | https://ozon.ru/t/9oWPCu1 |
| Монитор IPS 2k 144hz 24'' | 10к-15к | https://ozon.ru/t/TODVU5I |
...
⚠️ Беговая дорожка — только полностью напольная (без стойки/консоли), чтобы помещалась под столом.
...
| Марк Аврелий — «Наедине с собой» | ??к | — |
